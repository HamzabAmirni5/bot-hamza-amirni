...
async function kickCommand(sock, chatId, msg, args) {
    ...
    try {
        ...
        await sock.sendMessage(chatId, {
            text: t('group.kick_success', { users: usernames.join(', ') }),
            mentions: usersToKick
        });
    } catch (error) {
        console.error('Error in kick command:', error);
        await sock.sendMessage(chatId, {
            text: t('group.kick_error')
        });
    }
}
