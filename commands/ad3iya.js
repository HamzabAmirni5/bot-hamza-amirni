...
const islamicDuas = [
    ...
    { title: "دعاء المساء", dua: "اللَّهُمَّ بِكَ أَمْسَيْنَا، وَبِكَ أَصْبَحْنَا، وَبِكَ نَحْيَا، وَبِكَ نَمُوتُ، وَإِلَيْكَ الْمَصِيرُ. أَمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ، لَا إِلَهَ إِلَّا اللهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ.", category: "مساء" },
    ...
    { title: "ساعة الاستجابة يوم الجمعة", dua: "اللَّهُمَّ مَا قَسَمْتَ فِي هَذَا الْيَوْمِ مِنْ خَيْرٍ وَصِحَّةٍ وَسَعَةِ رِزْقٍ فَاجْعَلْ لَنَا مِنْهُ نَصِيبًا، وَمَا أَنْزَلْتَ فِيهِ مِنْ شَرٍّ وَبَلَاءٍ وَفِتْنَةٍ فَاصْرِفْهُ عَنَّا وَعَنْ جَمِيعِ الْمُسْلِمِينَ.", category: "جمعة" },
...
function startScheduler(sock) {
    ...
    global.duasInterval = setInterval(async () => {
        ...
        if (now.minutes() === 0 && hours.includes(now.hours())) {
            ...
            const dua = isFriday ? getRandomDua('جمعة') : getRandomDua();
            const message = `🤲 *${isFriday ? 'دعاء يوم الجمعة' : 'دعاء اليوم'}*\n\n📿 ${dua.dua}`;
            for (const id of data.subscribers) {
