...
const linksConvert = {
    ...
    "png-jpg": {
        ...
        "params": { "format": "jpg", "percentage": 85, "background": "#ffffff" },
        "req_params": [],
        "split": {
            "start": "<img src=\"",
            "end": "\" style=\"width:"
    ...
    "png-gif": {
        "url": "https://ezgif.com/png-to-jpg",
        "params": { "format": "gif", "percentage": 85, "background": "#ffffff" },
        "req_params": [],
        "split": {
            "start": "<img src=\"",
            "end": "\" style=\"width:"
    ...
    "png-bmp": {
        "url": "https://ezgif.com/png-to-jpg",
        "params": { "format": "bmp", "percentage": 85, "background": "#ffffff" },
        "req_params": [],
        "split": {
            "start": "<img src=\"",
            "end": "\" style=\"width:"
    ...
    "svg-jpg": {
        ...
        "params": { "percentage": 85, "background": "#ffffff", "currentcolor": "#000000" },
        "req_params": [],
        "split": {
            "start": "<img src=\"",
            "end": "\" style=\"width:"
    ...
    "avif-jpg": {
        ...
        "params": { "percentage": 85, "background": "#ffffff" },
        "req_params": [],
        "split": {
            "start": "<img src=\"",
            "end": "\" style=\"width:"
...
async function overlay(fields) {
    ...
    form_over.append('new-overlay', fields.overlay.file, {
